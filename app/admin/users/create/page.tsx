    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500">
          Add a new member to the MannMilap platform.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-[11px] font-black uppercase tracking-wider text-gray-700 ml-1">
                Full Name
              </label>
        ...
        <input type="hidden" name="dateOfBirth" value="2000-01-01" />
        <input type="hidden" name="preferredCulture" value="General" />
        <input
          type="hidden"
          name="bio"
          value="Account created via Admin Dashboard"
        />
