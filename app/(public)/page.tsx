      ...
      <section id="features" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Cultural Values", desc: "Shared traditions & respect", icon: "🌸" },
              { title: "Meaningful Matches", desc: "Compatibility over swipes", icon: "🤝" },
              { title: "Safe & Secure", desc: "Privacy-first verified profiles", icon: "🛡️" },
              { title: "Authentic Connections", desc: "Real bonds that last", icon: "✨" },
            ].map((item) => (
              <div
                key={item.title}
